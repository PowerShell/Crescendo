            ...
            $testCases = $fileList |
                Foreach-Object {
                    ...
                    @{
                        ...
                        JSON = $json
                        SchemaUrl = $_.FullName -match "ExportCrescendoCommand1|ExcludeAsArg|ifconfig.filter|ArgumentTransform|ls.poperror|MultiHandler" ? "${schemaBase}/2022-06" : "${schemaBase}/2021-11"
                    }
                }
